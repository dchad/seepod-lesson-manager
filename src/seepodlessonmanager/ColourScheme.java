...
/*
 * Project: SeePod ID3 Lesson Manager
...
public class ColourScheme implements SPConstants
{
   ...
   public void testUILookAndFeel(ColourSchemeDialog csd)  //DEPRECATED: causes instability with the dialog still open
   {
      setUILookAndFeel();  
      aFrame = seePodConfig.getAppFrame();
      pdfFrame = seePodConfig.getPDFFrame();
   ...
   public void resetUITree()
   {
      ...
      SwingUtilities.updateComponentTreeUI(pdfFrame);
      Main.resetUI();
      Main.seePodDownloadPanel.resetUI();
      Main.seePodTagPanel.resetUI();
      Main.seePodLessonPanel.resetUI();
      Main.seePodVocabPanel.resetUI();
      Main.seePodDatabasePanel.resetUI();
      aFrame.pack();
      pdfFrame.pack();
   }
